          ...
          <div className="studio-block-list" style={{ padding: '8px 0' }}>
            {blocks.map((block) => (
              ...
              >
                ...
                <MoreHorizontal
                  size={12}
                  style={{ opacity: 0, flexShrink: 0, transition: 'opacity 80ms' }}
                  className="block-item-more"
                />
              </div>
            ))}
          </div>
          ...
          <div style={{ padding: '12px 14px', overflowY: 'auto', flex: 1 }}>
            ...
            <div className="inspector-field">
              ...
              <input
                ...
                defaultValue={selectedPlaceholder.name}
              />
            </div>
            ...
            {[
              ...
              { label: 'Trim whitespace', on: true },
              { label: 'Regex pattern', on: false },
            ].map((t) => (
