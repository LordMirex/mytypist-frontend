...
const Login = () => {
  ...
  return (
    <AuthLayout title="Sign In - MyTypist" description="Sign in to your MyTypist account to access professional document tools">
      <Card className="shadow-2xl border-0 backdrop-blur-sm bg-white/95">
        <CardHeader className="text-center pb-6">
          <CardTitle className="text-2xl font-bold text-gray-900">Welcome back</CardTitle>
          <p className="text-gray-600 mt-2">Sign in to continue creating professional documents</p>
        </CardHeader>
