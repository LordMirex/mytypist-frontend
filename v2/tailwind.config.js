  ...
  theme: {
    extend: {
      colors: {
        ...
        conversion: {
          DEFAULT: 'var(--color-conversion)', // orange-600
          foreground: 'var(--color-conversion-foreground)', // white
        },
        'brand-authority': {
          DEFAULT: 'var(--color-brand-authority)', // blue-800
          foreground: 'var(--color-brand-authority-foreground)', // white
        },
        trust: {
        ...
        canvas: {
          DEFAULT: 'var(--color-canvas)', // slate-50
          foreground: 'var(--color-canvas-foreground)', // gray-800
        },
      },
      fontFamily: {
      ...
      boxShadow: {
        ...
        'conversion': '0 8px 25px rgba(245, 158, 11, 0.3)',
        'trust': '0 0 20px rgba(16, 185, 129, 0.2)',
